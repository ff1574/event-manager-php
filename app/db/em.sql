...
(1, 'Kristina', 'Marasović', 'kxmzgr@rit.edu', 'kmarasovic', '1234', 1),
(2, 'Franko', 'Fišter', 'ff1574@rit.edu', 'franko', 'admin', 1),
(3, 'John', 'Doe', 'john.doe@example.com', 'john', '4321', 2), 
(4, 'Jane', 'Doe', 'jane.doe@example.com', 'jane', '4321', 2),
(5, 'Emily', 'Smith', 'emily.smith@example.com', 'emsmith', 'em', 2),
(6, 'Michael', 'Johnson', 'michael.johnson@example.com', 'mjohnson', 'johnny', 2),
(7, 'Anna', 'Taylor', 'anna.taylor@example.com', 'annat', 'anna', 2),
(8, 'Robert', 'Brown', 'robert.brown@example.com', 'rbrown', 'robby', 2),
(9, 'Linda', 'White', 'linda.white@example.com', 'lwhite', 'walter123', 2);
UNLOCK TABLES;
